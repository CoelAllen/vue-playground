    ...
    <div class="row">
      <div class="col-12">
        <div class="border p-1">
          ...
          <div class="player-card text-center" v-for="(banana, index) in state.players">
            <h5>Player: {{index+1}}</h5>
            <div>
              <img class="img" :src=banana.photo />
            </div>
            <div>
              <span>{{banana.name}}</span>
            </div>
            <div>
              <span>{{banana.position}}</span>
            </div>
            <div>
              <span>{{banana.number}}</span>
            </div>
          </div>
        </div>
        <div class="border p-1">
